...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pagination_theme__ = __webpack_require__("../../../../../src/components/pagination.theme.ts");
...
var CloukitPaginationButtonComponent = (function () {
    ...
    CloukitPaginationButtonComponent.prototype.ngOnChanges = function () {
        ...
        this.ui = __WEBPACK_IMPORTED_MODULE_2__pagination_theme__["b" /* Ui */].transform(this.paginationItem);
        if (modifier !== null && this.isMouseStillOver) {
            this.ui.modifier = modifier;
        }
        if (this.disabled === true) {
            this.ui.state = __WEBPACK_IMPORTED_MODULE_2__pagination_theme__["b" /* Ui */].states.disabled;
            this.ui.modifier = __WEBPACK_IMPORTED_MODULE_2__pagination_theme__["b" /* Ui */].modifier.base;
        }
        this.updateStyle();
    };
    CloukitPaginationButtonComponent.prototype.mouseEnter = function () {
        this.ui.modifier = __WEBPACK_IMPORTED_MODULE_2__pagination_theme__["b" /* Ui */].modifier.hover;
    ...
    CloukitPaginationButtonComponent.prototype.doClick = function () {
        if (!this.paginationItem.isFiller) {
            this.onClick.emit(new __WEBPACK_IMPORTED_MODULE_3__pagination_model__["a" /* PaginationButtonClickEvent */](this.type, this.paginationItem.page));
        }
    };
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* Input */])(),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_3__pagination_model__["b" /* PaginationButtonType */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__pagination_model__["b" /* PaginationButtonType */]) === "function" && _a || Object)
], CloukitPaginationButtonComponent.prototype, "type", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* Input */])(),
    __metadata("design:type", typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__pagination_model__["c" /* PaginationItem */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__pagination_model__["c" /* PaginationItem */]) === "function" && _b || Object)
...
CloukitPaginationButtonComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
...
var Ui = (function () {
    ...
    Ui.transform = function (pageItem) {
        if (Object(__WEBPACK_IMPORTED_MODULE_1_util__["isNullOrUndefined"])(pageItem)) {
            return new __WEBPACK_IMPORTED_MODULE_0__cloukit_theme__["d" /* UiElement */](Ui.elements.filler, Ui.states.disabled, Ui.modifier.base);
        }
        ...
        return new __WEBPACK_IMPORTED_MODULE_0__cloukit_theme__["d" /* UiElement */](uiElement, uiState, Ui.modifier.base);
    };
    return Ui;
}());
...
var CloukitPaginationComponentThemeDefault = (function (_super) {
    ...
    function CloukitPaginationComponentThemeDefault() {
        ...
        // WRAPPER
        //
        _this.createStyle('wrapper', 'normal', 'base', {
            style: {
                display: 'flex',
                width: '100%',
            }
        ...
        // BUTTON
        //
        _this.createStyle(Ui.elements.button, Ui.states.normal, Ui.modifier.base, {
            style: {
                alignSelf: 'center',
                display: 'inline-flex',
                flexWrap: 'nowrap',
        ...
        _this.createStyle(Ui.elements.button, Ui.states.active, Ui.modifier.base, _this.merge(_this.getStyle(Ui.elements.button, Ui.states.normal, Ui.modifier.base), {
            style: {
        ...
        _this.createStyle(Ui.elements.button, Ui.states.normal, Ui.modifier.hover, _this.merge(_this.getStyle(Ui.elements.button, Ui.states.normal, Ui.modifier.base), {
            style: {
                textDecoration: 'underline',
            }
        }));
        _this.createStyle(Ui.elements.button, Ui.states.disabled, Ui.modifier.base, _this.merge(_this.getStyle(Ui.elements.button, Ui.states.normal, Ui.modifier.base), {
            style: {
                color: '#777',
                cursor: 'not-allowed',
            }
        ...
        // FILLER
        //
        _this.createStyle(Ui.elements.filler, Ui.states.normal, Ui.modifier.base, _this.merge(_this.getStyle(Ui.elements.button, Ui.states.normal, Ui.modifier.base), {
            style: {
                color: '#555',
                cursor: 'default',
            }
        }));
        _this.createStyle(Ui.elements.filler, Ui.states.disabled, Ui.modifier.base, _this.merge(_this.getStyle(Ui.elements.filler, Ui.states.normal, Ui.modifier.base), {
            style: {
                color: '#efefef',
                cursor: 'not-allowed',
            }
